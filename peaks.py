...
def smooth(image,size):
    ...
    # gauss_kernel=Gaussian2DKernel(size)
    # z=convolve(image,gauss_kernel,normalize_kernel=True)
    box_kernel=Box2DKernel(size)
    z=convolve(image,box_kernel,normalize_kernel=True)
    return z
